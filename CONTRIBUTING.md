...
[GitHub Discussions](https://github.com/pwrlabs/pwrcsharp/discussions)
to see if it's already being discussed. You can help us by
[submitting an issue on GitHub](https://github.com/pwrlabs/pwrcsharp/issues).
...
1. Search our repository for open or closed
   [Pull Requests](https://github.com/pwrlabs/pwrcsharp/pulls) that
   relate to your submission. You don't want to duplicate effort.
2. Fork the project
3. Create your feature branch (`git checkout -b feat/amazing_feature`)
4. Commit your changes (`git commit -m 'feat: add amazing_feature'`)
5. Push to the branch (`git push origin feat/amazing_feature`)
6. [Open a Pull Request](https://github.com/pwrlabs/pwrcsharp/compare?expand=1)
